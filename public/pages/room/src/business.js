class Business {
    ...
    onUserDisconnected() {
        return userId => {
            ...
            this.view.removeVideElement(userId);
        }
    }
    ...
    onPeerCallError() {
        return (call, error) => {
            console.log('an call errror ocurred! ', error);
            this.view.removeVideElement(call.peer);
        }
    }
    ...
    onLeavePressed(){
        console.log('pressionou Leave');
        this.userRecordings.forEach((values, key) => value.download())
    }
